...
class SampleModel extends Listenable {
  ...
  String syncfusionIcon = 'lib/assets/images/syncfusion.png';
  ...
  void changeTheme(ThemeData _themeData) {
    ...
    switch (_themeData.brightness) {
      case Brightness.dark:
        {
          syncfusionIcon = 'lib/assets/images/syncfusion_dark.png';
      ...
      default:
        {
          syncfusionIcon = 'lib/assets/images/syncfusion.png';
