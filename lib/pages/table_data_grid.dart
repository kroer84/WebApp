...
List<EdoCuentaIndividual> estadosDeCuenta;
...
class _TableDataGridState extends SampleViewState {
  EdoCuentaIndividualDataGridSource datoSource =
      EdoCuentaIndividualDataGridSource();
  final ColumnSizer _columnSizer = ColumnSizer();
  GridLinesVisibility gridLineVisibility;
  CustomPopupMenu _selectedChoices;
  EdoCuentaIndividual eci = EdoCuentaIndividual();
  ...
  void initState() {
    ...
    estadosDeCuenta = Sesion.miSesion.edosCuenta;
  }
  ...
  Widget getCellWidget(BuildContext context, GridColumn column, int rowIndex) {
    if (eci.titulos[column.mappingName] == "Texto")
      return formateaTexto(eci.obtenValor(
          column.mappingName, Sesion.miSesion.edosCuenta[rowIndex]));
...
class EdoCuentaIndividualDataGridSource
    extends DataGridSource<EdoCuentaIndividual> {
  EdoCuentaIndividualDataGridSource();
  EdoCuentaIndividual eci = EdoCuentaIndividual();
  @override
  List<EdoCuentaIndividual> get dataSource => estadosDeCuenta;
  @override
  Object getValue(EdoCuentaIndividual _datos, String columName) {
